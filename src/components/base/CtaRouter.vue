...
.icon-container {
  border: 1px solid var(--bg-color, $c-highlight);
  width: rem(32);
  height: rem(32);
  ...
  @include hover {
    &:hover {
      border-color: var(--accent-color, $c-cta);

      .icon {
        color: var(--accent-color, $c-cta);
...
.icon {
  color: var(--bg-color, $c-highlight);
  width: rem(20);
  height: rem(20);
  transition:
